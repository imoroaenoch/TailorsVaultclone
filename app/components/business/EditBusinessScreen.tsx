...
export default function EditBusinessScreen({ theme, toggleTheme, currentScreen, onNavigate }: EditBusinessScreenProps) {
    return (
        <div id="edit-business-screen" className="screen" style={{ display: currentScreen === 'edit-business-screen' ? 'block' : 'none' }}>
            <nav className="top-navbar">
                <div className="navbar-content">
                    <button
                        id="back-from-edit-business-btn"
