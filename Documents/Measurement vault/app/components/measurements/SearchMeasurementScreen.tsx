...
interface SearchMeasurementScreenProps {
    theme: 'dark' | 'light'
    toggleTheme: () => void
...
export default function SearchMeasurementScreen({ theme, toggleTheme, currentScreen, onNavigate }: SearchMeasurementScreenProps) {
    return (
        <div id="search-screen" className="screen" style={{ display: currentScreen === 'search-screen' ? 'block' : 'none' }}>
