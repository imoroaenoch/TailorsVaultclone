                    ...
                    <div className="measurements-section">
                        ...
                        <div className="measurements-grid">
                            <div className="form-group">
                                ...
                                <input type="text" id="shoulder" placeholder="0.0" autoComplete="off" />
                            </div>

                            <div className="form-group">
                                <label htmlFor="chest">Chest</label>
                                <input type="text" id="chest" placeholder="0.0" autoComplete="off" />
                            </div>

                            <div className="form-group">
                                <label htmlFor="waist">Waist</label>
                                <input type="text" id="waist" placeholder="0.0" autoComplete="off" />
                            </div>

                            <div className="form-group">
                                <label htmlFor="sleeve">Sleeve</label>
                                <input type="text" id="sleeve" placeholder="0.0" autoComplete="off" />
                            </div>

                            <div className="form-group">
                                <label htmlFor="length">Length</label>
                                <input type="text" id="length" placeholder="0.0" autoComplete="off" />
                            </div>

                            <div className="form-group">
                                <label htmlFor="neck">Neck</label>
                                <input type="text" id="neck" placeholder="0.0" autoComplete="off" />
                            </div>

                            <div className="form-group">
                                <label htmlFor="hip">Hip</label>
                                <input type="text" id="hip" placeholder="0.0" autoComplete="off" />
                            </div>

                            <div className="form-group">
                                <label htmlFor="inseam">Inseam</label>
                                <input type="text" id="inseam" placeholder="0.0" autoComplete="off" />
                            </div>

                            <div className="form-group">
                                <label htmlFor="thigh">Thigh</label>
                                <input type="text" id="thigh" placeholder="0.0" autoComplete="off" />
                            </div>

                            <div className="form-group">
                                <label htmlFor="seat">Seat</label>
                                <input type="text" id="seat" placeholder="0.0" autoComplete="off" />
                            </div>
